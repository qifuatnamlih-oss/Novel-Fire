...
export default async function handler(req, res) {
  ...
  if (!content) {
    return res.status(400).json({ refinedContent: '', error: 'Konten tidak ditemukan dalam request' });
  }
...
7. OUTPUT WAJIB: Hanya berikan teks hasil revisi saja tanpa kalimat pengantar, penjelasan, atau tanda kutip pembungkus di luar teks novel.
